...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/crm/list.action" method="get">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">				<%--customer--%>
							<pg:page url="${pageContext.request.contextPath }/crm/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
	...
	<script type="text/javascript">
		...
		function updateCustomer() {
			$.post("<%=basePath%>crm/update.action",$("#edit_customer_form").serialize(),function(data){
				if (data =="0"){
					alert("客户信息更新成功！");
				}else {
					alert("客户信息更新失败！");
		...
		function deleteCustomer(id) {
			if(confirm('确实要删除该客户吗?')) {
				$.post("<%=basePath%>crm/delete.action",{"id":id},function(data){
					if (data =="0"){
						alert("客户信息删除成功！");
					}else {
						alert("客户信息删除失败！");
